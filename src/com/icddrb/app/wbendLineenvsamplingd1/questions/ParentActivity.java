...
*/		// motion();
	...
	private void loadGuiFrmMessage(final ViewGroup v) {
		...
		//code by imtiaz khan
		if(CommonStaticClass.questionMap.get(CommonStaticClass.currentSLNo).getQvar().equalsIgnoreCase("m11")
				||CommonStaticClass.questionMap
				.get(CommonStaticClass.currentSLNo).getQvar().equalsIgnoreCase("q331m")
				||CommonStaticClass.questionMap.
				get(CommonStaticClass.currentSLNo).getQvar().equalsIgnoreCase("q414m")
				||CommonStaticClass.questionMap.
